...
function ifWeekendAndWorkExist() {
  let text = '';
  for (let entry of JOURNAL) {
...
const JOURNAL = [
  new Entry(["carrot", "exercise", "weekend", "work"], false),
  ...
  new Entry(["carrot", "nachos", "brushed teeth", "exercise", "work", "weekend"], false),
  ...
  new Entry(["carrot", "pudding", "brushed teeth", "weekend", "work"], false),
